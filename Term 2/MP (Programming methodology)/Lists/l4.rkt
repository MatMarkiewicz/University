        ...
        [(= x (node-val t))
         (if (eq? (cadddr t) `leaf)
             ...
             (let ((min (bst-min (cadddr t))))
               (make-node min (caddr t) (delete min (cadddr t)))))]
        [(> x (node-val t)) (make-node (node-val t) (caddr t) (delete x (cadddr t)))]
        [(< x (node-val t)) (make-node (node-val t) (delete x (caddr t)) (cadddr t))]))

(define test-bst-tree `(node 5 (node 2 (node 1 leaf leaf) (node 4 leaf leaf)) (node 8 (node 6 leaf leaf) (node 9 leaf leaf))))
