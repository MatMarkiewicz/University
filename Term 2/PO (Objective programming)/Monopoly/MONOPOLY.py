...
# Program jest projektem zaliczeniowym na przedmiot Programowanie Obiektowe
# Autorem programu jest Mateusz Markiewicz, nr indeksu 298653
...
class Board:
	def __init__(self):
		...
		i = 0
		self.prop_by_color = [[],[],[],[],[],[],[],[],[],[]]
		# deklarowanie pól składających się na plansze
		properties = [
		Special_property(9,9,"   START  "),
		Brown_property(9,8," Old Kent "),
		Brown_property(9,7," Whitech  "),
		Brown_property(9,6,"    Baltic    "),
		Railway(9,5," Cross St. "),
		Light_blue_property(9,4,"  Oriental  "),
		Light_blue_property(9,3," Vermont "),
		Light_blue_property(9,2,"   Euston   "),
		Light_blue_property(9,1,"Pentonvill"),
		Special_property(9,0,"     Jail     "),
		Pink_property(8,0," Pall Mall "),
		Pink_property(7,0,"Whitehall"),
		Pink_property(6,0,"  Virginia  "),
		Railway(5,0,"Marylebo."),
		Orange_property(4,0,"  Bow St.  "),
		Orange_property(3,0,"  Marlbor  "),
		Orange_property(2,0,"   Vine St.  "),
		Orange_property(1,0," New York"),
		Special_property(0,0,"  Parking  "),
		Red_property(0,1," Kentucky"),
		Red_property(0,2,"  Fleet St.  "),
		Red_property(0,3," Trafalgar "),
		Railway(0,4," Fenchur."),
		Yellow_property(0,5," Leicester "),
		Yellow_property(0,6," Coventry "),
		Yellow_property(0,7,"  Picadilly "),
		Yellow_property(0,8,"   Marvin  "),
		Go_to_jail(0,9,"Go to jail"),
		Green_property(1,9,"Regent St."),
		Green_property(2,9,"Oxford St."),
		Green_property(3,9,"  Bond St. "),
		Railway(4,9," Liverpool"),
		Green_property(5,9,"   Pacyfic  "),
		Dark_blue_property(6,9,"Park Lane"),
		Dark_blue_property(7,9,"Park Place"),
		Dark_blue_property(8,9,"  Mayfair  ")]
		# dodawanie pól do planszy
...
# klasa umożliwiająca wymianę pomiędzy graczami
class Exchange:
	...
	def print_exchange(self):
		# metoda wyświetlania okna wymiany wraz z przyciskami do interakcji
		...
		self.bendex = Button(self.fexchange, text = "Zakończ wymianę", 
			                command = lambda : (self.var_end_exchange.set(1), Var_interact.set(1)))
		...
		for i in range(len(self.player1.owned_properties)):
			...
			self.bsp1.append(Checkbutton(self.fexchange, text = self.player1.owned_properties[i].name, 
				                        variable = self.varsp1[i]))
		...
		for i in range(len(self.player2.owned_properties)):
			...
			self.bsp2.append(Checkbutton(self.fexchange, text = self.player2.owned_properties[i].name, 
				                        variable = self.varsp2[i]))
...
class Game:
	def __init__(self,players):
		self.board = Board()
		self.players = []
		for i in range(min(len(players),5)):
			self.players.append(Player(players[i][0],players[i][1],i,10))
		self.dice1 = Dice(2,3,"Kostka 1:")
		self.dice2 = Dice(2,6,"Kostka 2:")
	...
	def play(self):
		...
		bdices = Button(okno,text="LOSUJ",command = lambda: (self.dice1.roll(), self.dice2.roll(), 
			                                                Var_kostki.set(1)))
		self.bend = Button(okno,text="ZAKOŃCZ",command = lambda : (Var_interact.set(1), self.__end()))
		self.bbuy = Button(okno, text = "KUP", command = lambda: (Var_interact.set(1),
			                                current_property.buy_property(current_player, self.board)))
		...
		while True:
			...
			self.dice1.lval.configure(text="")
			self.dice2.lval.configure(text="")
			...
			self.dice1.lval.configure(text=self.dice1.val) # wyświetlenie wartości rzutów
			self.dice2.lval.configure(text=self.dice2.val)
...
gracz1 = ["Gracz 1","green"]
gracz2 = ["Gracz 2","blue"]
gracz3 = ["Gracz 3", "yellow"]
