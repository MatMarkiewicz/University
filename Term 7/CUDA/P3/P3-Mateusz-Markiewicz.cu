// Rozwiązanie zaprezentowane na pracowni 02.12

// Zad.3 Optymalne parametry dla wersji 1:
//#define BLOCK_X 32
//#define BLOCK_Y 32

// Zad.4 Optymalne parametry dla wersji 2:
// #define BLOCK_X 32
// #define BLOCK_Y 2
// #define BLOCK_Z 2

// Zad 6 czasy działania dla poszególnych wersji:
// 256,256,256 - 7.4ms
// 255,255,255 - 7.6ms
// 256,255,255 - 7.3ms

// Zad. 7 - 4*256*256*256*(6+1)*1e-9/(0.74*1e-3) = 635GB/s
// Tesla T4 - colab
...
int main(int argc, const char **argv){
  ...
  int    NX=256, NY=255, NZ=255, REPEAT=10,
         bx, by, bz, i, j, k, ind;
